...
public abstract interface LocationDao {
    ...
    @androidx.room.Query(value = "SELECT * FROM locations WHERE id == :id LIMIT 1")
    @org.jetbrains.annotations.Nullable()
